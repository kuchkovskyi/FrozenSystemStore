...
namespace Project_P34.API_Angular.Migrations
{
    ...
    [Migration("20200516010405_Wishes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project_P34.DataAccess.Entity.Product", b =>
                {
                    ...
                    b.Property<string>("FirstAdditionalImage")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SecondAdditionalImage")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ThirdAdditionalImage")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Project_P34.DataAccess.Entity.ShoppingCart", b =>
                {
                    b.HasOne("Project_P34.DataAccess.Entity.Product", "ProductOf")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Project_P34.DataAccess.Entity.User", "UserOf")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
